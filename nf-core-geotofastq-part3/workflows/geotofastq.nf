...
def checkPathParamList = [ params.input, params.multiqc_config, params.geo ]
...
include { CHECK_INPUT } from '../subworkflows/local/check_input' addParams( options: [:] )
include { CHECK_GEO } from '../subworkflows/local/check_geo' addParams( options: [:] )
